...
public class BarcoPirata extends JFrame {
    ...
    private static final int WOOD_REQUIREMENTS = 700;
    private static final int STONE_REQUIRIMENTS = 129;
    private static final int IRON_REQUIRIMENTS = 200;
    private static final int DIAMOND_REQUIRIMENTS = 12;
    private static final int GOLD_REQUIRIMENTS = 70;
    ...
    public BarcoPirata() {
        ...
        setTitle("Proyecto Barco Pirata");
    ...
    private JLabel putImage() {
        String sourceImageCastle = "BarcoPirata.jpg";
    ...
    public void doConstruction(ActionEvent e) {
        ...
        if (checkNumberMaterials(SeleccionDeMateriales.getMyMaterials())) {
            ...
            try {
                ...
                String filePath = "BarcoPirata" + auxFilePath + ".txt";
                FileWriter fileWriter = new FileWriter(filePath);
                BufferedWriter writer = new BufferedWriter(fileWriter);
                writer.write("Nombre del proyecto: " + "BarcoPirata" + auxFilePath);
                ...
                writer.write("\nOro: " + newGoldValue);
                writer.close();
                confirmArea.setText("Proyecto BarcoPirata " + auxFilePath + " creado correctamente");

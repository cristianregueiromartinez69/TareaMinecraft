...
public class FundicionAutomatica extends JFrame {
    ...
    public FundicionAutomatica() {

        setTitle("Proyecto Fundicion Automatica");
    ...
    private JLabel putImage() {
        String sourceImageCastle = "FundicionAutomatica.jpg";
    ...
    public void doConstruction(ActionEvent e) {
        ...
        if (checkNumberMaterials(SeleccionDeMateriales.getMyMaterials())) {
            ...
            try {
                ...
                String filePath = "FundicionAutomatica" + auxFilePath + ".txt";
                FileWriter fileWriter = new FileWriter(filePath);
                BufferedWriter writer = new BufferedWriter(fileWriter);
                writer.write("Nombre del proyecto: " + "FundicionAutomatica" + auxFilePath);
                ...
                writer.write("\nOro: " + newGoldValue);
                writer.close();
                confirmArea.setText("Proyecto FundicionAutomatica " + auxFilePath + " creado correctamente");
